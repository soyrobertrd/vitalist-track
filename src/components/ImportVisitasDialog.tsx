...
interface ImportVisitasDialogProps {
  onSuccess: () => void;
}

export const ImportVisitasDialog = ({ onSuccess }: ImportVisitasDialogProps) => {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const requiredFields = ["paciente_cedula", "profesional_cedula", "fecha_hora_visita", "tipo_visita"];
      ...
      const visitasToInsert = data
        ...
        .map(d => ({
          ...
          motivo_visita: d.motivo_visita || null,
          estado: d.estado || "pendiente",
          notas_visita: d.notas_visita || null,
        }));

      if (visitasToInsert.length === 0) {
      ...
      toast.success(`${visitasToInsert.length} visitas importadas exitosamente`);
      setOpen(false);
      onSuccess();
    } catch (error: any) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Importar Visitas Masivamente</DialogTitle>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <div className="space-y-3 p-4 bg-muted rounded-lg">
            ...
            <ul className="text-sm space-y-1 list-disc list-inside">
              ...
              <li><strong>fecha_hora_visita</strong>: Fecha y hora (formato: YYYY-MM-DD HH:MM:SS)</li>
              <li><strong>tipo_visita</strong>: Tipo (ambulatorio o domicilio)</li>
              <li>motivo_visita: Motivo de la visita (opcional)</li>
              <li>estado: Estado (pendiente, realizada, etc.) (opcional)</li>
              <li>notas_visita: Notas adicionales (opcional)</li>
            </ul>
          </div>
...
{`[
  {
    ...
    "fecha_hora_visita": "2024-12-15 14:00:00",
    "tipo_visita": "domicilio",
    "motivo_visita": "Control mensual"
  }
]`}
              </pre>
            </div>
            ...
            <div className="flex-1 p-3 border rounded-lg space-y-2">
              ...
              <pre className="text-xs bg-background p-2 rounded overflow-x-auto">
{`paciente_cedula,profesional_cedula,fecha_hora_visita,tipo_visita
001-1234567-8,031-0123456-7,2024-12-15 14:00:00,domicilio`}
              </pre>
            </div>
          </div>
